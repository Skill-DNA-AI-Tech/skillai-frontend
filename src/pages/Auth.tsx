              ...
              {mode === 'admin_otp' && (
                <div className="grid gap-4">
                  <div className="rounded-xl border border-cyan-500/30 bg-cyan-500/10 p-4 text-xs text-cyan-200">
                    ...
                    <p className="text-[11px] text-slate-400 mt-2">Fallback developer OTP code is <code className="bg-slate-900 px-1 py-0.5 rounded text-cyan-300">123456</code> if email dispatch is pending.</p>
                  </div>
