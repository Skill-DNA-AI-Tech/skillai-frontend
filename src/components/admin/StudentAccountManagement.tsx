                  ...
                  <tr key={student._id} className="hover:bg-white/[0.02] transition-colors">
                    ...
                    <td className="p-4">
                      <span className={`inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-medium border ${
                        ...
                        <span className={`h-1.5 w-1.5 rounded-full ${student.requiresPasswordChange ? 'bg-amber-400' : 'bg-emerald-400'}`} />
                        {student.requiresPasswordChange ? 'Initial PW' : 'Active'}
                      </span>
                    </td>
      ...
      {showIssueCertModal && selectedStudentForCert && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center p-4 z-50 overflow-y-auto">
          <div className="bg-gradient-to-br from-slate-900 via-slate-900 to-slate-950 rounded-2xl border border-cyan-500/20 max-w-lg w-full p-6 shadow-2xl relative my-8">
            ...
            <form onSubmit={handleIssueCertSubmit} className="space-y-4 mt-4">
              ...
              <div className="pt-2 flex gap-3">
                ...
                >
                  ...
                  {submittingCert ? 'Issuing & Signing...' : 'Issue Certificate'}
                </button>
              </div>
            </form>
          </div>
